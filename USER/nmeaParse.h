...
#define     GPS_PARSE_STATUS_LATITUDE      0x01  //½âÎöµ½LATITUDE
#define     GPS_PARSE_STATUS_LONGTITUDE    0x02  //½âÎöµ½LONGTITUDE
#define     GPS_PARSE_STATUS_CRC_START     0x10  //½âÎöµ½CRC Ğ£Ñé¿ªÊ¼µØ·½
#define     GPS_PARSE_STATUS_CRC_END       0x20  //½âÎöµ½CRC Ğ£Ñé½áÊøµØ·½
