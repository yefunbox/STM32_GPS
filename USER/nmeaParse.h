...
enum nmeaPACKTYPE
{
	...
	GPGLL   = 0x2000,   //Geographic Position\A3\A8GLL\A3\A9\B6\A8Î»\B5\D8\C0\ED\D0\C5Ï¢

    GPTXT   = 0x0020,   /**< TXT - \B2\FAÆ·\D0\C5Ï¢\A1\A2\CC\EC\CF\DF×´Ì¬\A1\A2\C8\F2\C3\EB\B5\C8 */

    BDGSV   = 0x0040,   /**< GSV - \BFÉ¼\FB\CE\C0\D0\C7 */
    BDGSA   = 0x0080,   /**< GGA - \BE\AB\B6\C8\D2\F2\D7Óº\CD\D3\D0Ğ§\CE\C0\D0\C7 */

    GNZDA   = 0x0100,   /**< ZDA - Ê±\BC\E4\BA\CD\C8\D5\C6\DA */
    GNGLL   = 0x0200,   /**< GLL - \B5\D8\C0\EDÎ»\D6\C3 \BE\ADÎ³\B6\C8 */
    GNVTG   = 0x0400,    /**< VTG - \B6Ôµ\D8\CBÙ¶ÈºÍº\BD\CF\F2 */
    GNRMC   = 0x0800,   /**< RMC - \CDÆ¼\F6\B5\C4\D7\EE\C9\D9×¨\D3Ãº\BD\CF\F2\CA\FD\BE\DD */
    GNGGA   = 0x1000,   /**< GGA - \BD\D3\CAÕ»\FA\B6\A8Î»\CA\FD\BEİ£\AC\CF\EAÏ¸*/
};
...
typedef struct _nmeaINFO
{
    ...
    double  sog;        /**< \CA\FDÖµ \B6Ôµ\D8\CBÙ¶È£\AC\B5\A5Î»Îª\BD\DA */
    double  speed;      /**< Speed over the ground in kilometers/hour */
    double  direction;  /**< Track angle in degrees True */
    double  declination; /**< Magnetic variation degrees (Easterly var. subtracts from true course) */
    char    mode;       /**< \D7Ö·\FB \B6\A8Î»Ä£Ê½\B1\EAÖ¾ (A = \D7\D4\D6\F7Ä£Ê½, D = \B2\EE\B7\D6Ä£Ê½, E = \B9\C0\CB\E3Ä£Ê½, N = \CA\FD\BE\DD\CE\DEĞ§) */
    nmeaSATINFO satinfo; /**< Satellites information */
    nmeaSATINFO BDsatinfo; /**\B1\B1\B6\B7\CE\C0\D0\C7\D0\C5Ï¢*/
...
typedef struct {                                           
    char latitude[15];             //Î³¶È ddmm.mmmmm:  2239.76703
    char longitude[16];            //¾­¶È dddmm.mmmmm:11401.32688
    u8 gpssta;                  //GPS×´Ì¬:0,Î´¶¨Î»;1,·Ç²î·Ö¶¨Î»;2,²î·Ö¶¨Î»;6,ÕıÔÚ¹ÀËã.                  
    u8 fixmode;                 //¶¨Î»ÀàĞÍ:1,Ã»ÓĞ¶¨Î»;2,2D¶¨Î»;3,3D¶¨Î»
    int altitude;               //º£°Î¸ß¶È,·Å´óÁË10±¶,Êµ¼Ê³ıÒÔ10.µ¥Î»:0.1m     
    u16 speed;                  //µØÃæËÙÂÊ,·Å´óÁË1000±¶,Êµ¼Ê³ıÒÔ10.µ¥Î»:0.001¹«Àï/Ğ¡Ê±  
    double dir;                /**< True track made good (degrees) */
    u8 hdop;                  //HDOPË®Æ½¾«¶ÈÒò×Ó 0.5~99.9
}NMEA_BASE_MSG; 
...
#define     GPS_PARSE_STATUS_CRC_START     0x10  //\BD\E2\CE\F6\B5\BDCRC Ğ£\D1é¿ªÊ¼\B5Ø·\BD
#define     GPS_PARSE_STATUS_CRC_END       0x20  //\BD\E2\CE\F6\B5\BDCRC Ğ£\D1\E9\BD\E1\CA\F8\B5Ø·\BD
#define     GPS_PARSE_STATUS_CRC_CRC1      0x40
#define     GPS_PARSE_STATUS_CRC_CRC2      0x80
//#define     GPS_PARSE_STATUS_CRC_DOING     0x40  //\BD\E2\CE\F6\B5\BDCRC Ğ£\D1\E9\BD\E1\CA\F8\B5Ø·\BD
